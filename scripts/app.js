...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const categoryNavbar = document.querySelector('.categories ');
    const dialogContent = document.querySelector('.dialog-content');
    const productCard = document.querySelector('.product-list');
    const productLeng = document.querySelector('.productlength');
      ...
      if (data && data.category) {
        data.category.forEach((element) => {
          ...
          categoryNavbar.innerHTML += `
            ...
            <div class="category hover-black text-black" data-id="${element.id}">${element.categoryName}</div>
            `;
          ...
          categoryLink.forEach((link) => {
            link.addEventListener('click', async (event) => {
              ...
              dataProduct.forEach(element => {
                ...
                <div class="product-image-wrapper">
                    <img class="product-image" data-product="${element.id}"  data-categoryId="${element.categoryId}" 
                        src="${element.productImage}"
                        alt="">
                    <div class="left-tag">NEW</div>
        
                    <div class="product-actions">
                        <div class="quick-look" data-product="${element.id}">QUICK LOOK</div>
                        <div class="like"><i class="fas fa-heart hover-secondary heart-icon"></i></div>
                    </div>
                </div>
                <div class="product-title">${element.productName}</div>
                <div class="product-footer">
                    <div class="add-to-cart text-black hover-secondary" data-name="${element.productName}" data-id="${element.id}" data-image="${element.productImage}" data-price="${element.price}">ADD TO CART</div>
            ...
            `;
                ...
                const btnCardButtons = document.querySelectorAll('.add-to-cart');
                const btnDetailButtons = document.querySelectorAll('.quick-look');
  
                const detail = document.querySelector('.details')
                const card = document.querySelectorAll('.product-image');
                card.forEach(button => {
